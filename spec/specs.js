describe('romanNums', function(){
  ...
  it("returns 'MDCL' if user input is 1650", function() {
  ...
  it("returns 'IX' if user input is 9", function() {
    expect(romanNums(9)).to.equal("IX");
  });

  it("returns 'XXIX' if user input is 29", function() {
    expect(romanNums(29)).to.equal("XXIX");
  });

  it("returns 'IV' if user input 4", function() {
    expect(romanNums(4)).to.equal("IV");
  });

  it("returns 'MCM' if user input is 1900", function() {
    expect(romanNums(1900)).to.equal("MCM");
  });

  it("returns 'MCMXC' if user input is 999", function() {
    expect(romanNums(999)).to.equal("CMXCIX");
  });
